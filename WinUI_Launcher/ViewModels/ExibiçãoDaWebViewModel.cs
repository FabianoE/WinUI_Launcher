...
public partial class ExibiçãoDaWebViewModel : ObservableRecipient, INavigationAware
{
    ...
    public ExibiçãoDaWebViewModel(IWebViewService webViewService)
    {
        WebViewService = webViewService;

        RunEvents.RegisterEvent(Classes.Events.EventsTypes.OpenWebView, (x) =>
        {
            Source = x as Uri;
        });
    }
